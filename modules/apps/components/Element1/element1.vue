<template>
  ...
  >
    <div class="container">
      ...
      >
      <div class="headings">
        <span class="title">Title goes here,if long use two lines</span>
        <div class="sub-title1">
          <span> Category</span>
          <div class="sub-title2">
            <span class="val1">01/01/2022 </span>
            <span class="val2">.</span>
            <span class="val3"> 19:00</span>
          </div>
         
          <div class="sub-title3">
            <span> Worm Rotterdam</span>
          </div>
        </div>
      </div>
    </div>
  ...
  height: 52%; /* Modifier la hauteur à 50% pour que l'image de couverture prenne la moitié de la hauteur de la carte */
